...
const Hero = () => {
    ...
    return (
        <div ref={containerRef} className="relative z-50 max-w-6xl mx-auto text-center px-6">
            {/* Premium badge */}
            <div
                className="fade-in inline-flex items-center px-6 py-2 mb-8 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full"
            >
          ...
          Meets Artistry
            ...
            <div className="fade-in max-w-3xl mx-auto mb-12">
                <p className="text-xl md:text-2xl text-white/80 leading-relaxed font-light">
                    ...
                    <span className="font-semibold bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text text-transparent">
            {" "}
